...
import net.mcreator.diesiraebleach.entity.renderer.KunaiRenderer;
import net.mcreator.diesiraebleach.DiesiraebleachModElements;

import java.util.Random;

@DiesiraebleachModElements.ModElement.Tag
public class KunaiItem extends DiesiraebleachModElements.ModElement {
	@ObjectHolder("diesiraebleach:kunai")
	...
	public KunaiItem(DiesiraebleachModElements instance) {
		super(instance, 26);
	...
	public static class ItemRanged extends Item {
		...
		public void onPlayerStoppedUsing(ItemStack itemstack, World world, LivingEntity entityLiving, int timeLeft) {
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					ItemStack stack = ShootableItem.getHeldAmmo(entity, e -> e.getItem() == ZangetsuHirakenItem.block);
					if (stack == ItemStack.EMPTY) {
						for (int i = 0; i < entity.inventory.mainInventory.size(); i++) {
							ItemStack teststack = entity.inventory.mainInventory.get(i);
							if (teststack != null && teststack.getItem() == ZangetsuHirakenItem.block) {
								stack = teststack;
								break;
							}
						}
					...
					if (entity.abilities.isCreativeMode || stack != ItemStack.EMPTY) {
						...
						if (entity.abilities.isCreativeMode) {
							...
							if (new ItemStack(ZangetsuHirakenItem.block).isDamageable()) {
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(ZangetsuHirakenItem.block);
		}
