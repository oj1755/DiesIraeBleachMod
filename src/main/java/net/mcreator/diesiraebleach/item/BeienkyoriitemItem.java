...
public class BeienkyoriitemItem extends DiesiraebleachModElements.ModElement {
	@ObjectHolder("diesiraebleach:beienkyoriitem")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("projectile_beienkyoriitem").setRegistryName("projectile_beienkyoriitem");

	public BeienkyoriitemItem(DiesiraebleachModElements instance) {
		super(instance, 44);
		FMLJavaModLoadingContext.get().getModEventBus().register(new BeienkyoriitemRenderer.ModelRegisterHandler());
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("beienkyoriitem");
		}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(BeienkyoriitemItem.block);
		}
