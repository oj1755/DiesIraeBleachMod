...
import net.mcreator.diesiraebleach.procedures.BeikatsudouProcedure;
...
public class QliphothBacikal2Item extends DiesiraebleachModElements.ModElement {
	...
	public static class ItemCustom extends Item {
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			BeikatsudouProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
