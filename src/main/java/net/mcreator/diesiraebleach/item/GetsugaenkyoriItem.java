...
import net.mcreator.diesiraebleach.entity.renderer.GetsugaenkyoriRenderer;
import net.mcreator.diesiraebleach.DiesiraebleachModElements;

import java.util.Random;

@DiesiraebleachModElements.ModElement.Tag
public class GetsugaenkyoriItem extends DiesiraebleachModElements.ModElement {
	@ObjectHolder("diesiraebleach:getsugaenkyori")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("projectile_getsugaenkyori").setRegistryName("projectile_getsugaenkyori");

	public GetsugaenkyoriItem(DiesiraebleachModElements instance) {
		super(instance, 43);
		FMLJavaModLoadingContext.get().getModEventBus().register(new GetsugaenkyoriRenderer.ModelRegisterHandler());
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("getsugaenkyori");
		}
