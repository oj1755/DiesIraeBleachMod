...
public class KatsudouKeyBinding extends DiesiraebleachModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public KatsudouKeyBinding(DiesiraebleachModElements instance) {
		super(instance, 33);
	...
	public void initElements() {
		keys = new KeyBinding("key.diesiraebleach.katsudou", GLFW.GLFW_KEY_R, "key.categories.misc");
