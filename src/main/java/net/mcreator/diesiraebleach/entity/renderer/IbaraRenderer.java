...
@OnlyIn(Dist.CLIENT)
public class IbaraRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(IbaraEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelKuinomori(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("diesiraebleach:textures/entities/toge.png");
					}
				};
			});
		}
