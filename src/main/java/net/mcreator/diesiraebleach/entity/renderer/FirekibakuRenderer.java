...
@OnlyIn(Dist.CLIENT)
public class FirekibakuRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(FirekibakuEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelFireballsmall(), 0.5f) {
					{
					...
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("diesiraebleach:textures/entities/fireballsmall.png");
					}
				};
			});
		}
	...
	private static class GlowingLayer<T extends Entity, M extends EntityModel<T>> extends LayerRenderer<T, M> {
		...
		public void render(MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn, T entitylivingbaseIn, float limbSwing,
			...
			IVertexBuilder ivertexbuilder = bufferIn
					.getBuffer(RenderType.getEyes(new ResourceLocation("diesiraebleach:textures/entities/fireballsmall.png")));
