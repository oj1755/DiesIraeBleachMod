...
public class PanzerFaustItemRenderer {
	...
	public static class ModelPanzerFaustAmmo extends EntityModel<Entity> {
		...
		public ModelPanzerFaustAmmo() {
			...
			bb_main.setTextureOffset(0, 0).addBox(-0.5F, -15.0F, -0.5F, 1.0F, 15.0F, 1.0F, 0.0F, false);
			bb_main.setTextureOffset(4, 0).addBox(-1.0F, -14.8F, -1.0F, 2.0F, 3.0F, 2.0F, 0.0F, false);
		}
